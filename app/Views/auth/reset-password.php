...
<head>
    ...
    <title>Reset Password - AI Banking GRC Platform</title>
...
<body>
    ...
    $(document).ready(function() {
        ...
        $('#password').on('keyup', function() {
            ...
            if (strength <= 25) {
                bar.css({ width: '25%', background: '#EF4444' });
                message = 'Weak password';
            } else if (strength <= 50) {
                bar.css({ width: '50%', background: '#F59E0B' });
                message = 'Fair password';
            } else if (strength <= 75) {
                bar.css({ width: '75%', background: '#3B82F6' });
                message = 'Good password';
            } else {
                bar.css({ width: '100%', background: '#22C55E' });
